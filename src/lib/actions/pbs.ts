...
[작성 가이드라인]
1. 기능 분석(functionAnalyzed): ABC 데이터를 바탕으로 행동의 기능(관심, 회피, 획득, 자극 등)을 유아의 발달적 욕구와 연결하여 명확히 가설화하십시오.
...
2. 각 필드(Value)는 유아교육 현장에서 바로 활용할 수 있도록 아주 **풍성하고 구체적인 문장(Bullet point 포함 가능)**으로 작성하십시오.

{
  "functionAnalyzed": "분석된 기능 및 유아기적 욕구 분석",
